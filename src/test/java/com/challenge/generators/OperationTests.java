...
public class OperationTests {
    ...
    public void testSumShouldPass(){
        Double returnValue = sumOperation.run(List.of(1.0, 5.0));
    ...
    public void testAverageShouldPass(){
        Double returnValue = averageOperation.run(List.of(4.0, 5.0));
    ...
    public void testMinShouldPass(){
        Double returnValue = minOperation.run(List.of(4.0, 5.0, 1.0, 0.2, 40.7));
    ...
    public void testMaxShouldPass(){
        Double returnValue = maxOperation.run(List.of(4.0, 5.0, 55.0, 37.0));
